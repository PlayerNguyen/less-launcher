...
import type { Library, Version } from "./types";
  ...
  describe("resolveResources", () => {
    ...
    it("resolves client JAR, libraries, natives, and assets", async () => {
        ...
        libraries: [
          ...
          },
          {
            ...
            downloads: {
              classifiers: {
                "natives-windows": {
                  path: "com/example/native/1.0/native-1.0-natives-windows.jar",
                  sha1: "natsha",
                  size: 300,
      ...
      expect(paths).toContain(
        "libraries/com/example/library/1.0/library-1.0.jar",
      );
      expect(paths).toContain(
        "libraries/com/example/native/1.0/native-1.0-natives-windows.jar",
      );
        ...
        libraries: [
          {
            ...
            downloads: {
              artifact: { path: "osx.jar", sha1: "x", size: 1, url: "url" },
            },
          },
        ],
      };
